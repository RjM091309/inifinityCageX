...
`;
	...
	try {
		...
		const [
			...
			pool.query(sqlWinlossManual),
			pool.query(sqlTotalRollingManual),
			pool.query(sqlAccountTransfer),
			pool.query(sqlCCChipsBuyinGame),
			pool.query(sqlCCChipsBuyinGameReset),
			pool.query(sqlJunketCredit),
			pool.query(sqlJunketExpense),
			pool.query(sqlJunketLoss),
			pool.query(sqlJunketExpenseGoods),
			pool.query(sqlJunketExpenseNonGoods),
			pool.query(sqlReturnMoney),
			pool.query(sqlJunketExpenseReset),
			pool.query(sqlHouseRollingReset),
			pool.query(sqlTotalRollingReset),
			pool.query(sqlTotalCashOutReset),
			pool.query(sqlTotalCashOutRollingReset),
			pool.query(sqlWinLossReset),
			pool.query(sqlAccountMarkerReturn),
			pool.query(sqlMxDepositExchangeAmount),
			pool.query(sqlMxReturnAmount),
			pool.query(sqlMxMarginReturn),
			pool.query(sqlMxPhpDepositIn),
			pool.query(sqlMxPhpDepositOut),
			pool.query(sqlMxCashNet),
			pool.query(sqlChipsReturnMarker),
			pool.query(sqlMArkerReturnDeposit),
			pool.query(sqlMArkerReturnCash),
			pool.query(sqlSettlementDepositAmount),
			pool.query(sqlSettlementCashOutAmount),
			pool.query(sqlAccountSettlement),
			pool.query(sqlNNChipsReturnDeposit),
			pool.query(sqlCageRolling),
			pool.query(sqlAccountCCChipsReturn),
			pool.query(sqlNNChipsAccountMarker),
			pool.query(sqlAccountDeduct),
			pool.query(sqlAccountWithdraw),
			pool.query(sqlAccountServicesDeduct),
			pool.query(sqlNNChipsAccountCash),
			pool.query(sqlCCChipsAccountCash),
			pool.query(sqlNNChipsAccountDeposit),
			pool.query(sqlCCChipsCashout),
			pool.query(sqlCCReturn),
			pool.query(sqlNNChipsCashout),
			pool.query(sqlNNReturn),
			pool.query(sqlTotalChipsCashout),
			pool.query(sqlCCChipsRolling),
			pool.query(sqlNNChipsRolling),
			pool.query(sqlTotalChipsRolling),
			pool.query(sqlCCChipsBuyin),
			pool.query(sqlCCBuyin),
			pool.query(sqlNNChipsBuyin),
			pool.query(sqlNNBuyin),
			pool.query(sqlTotalChipsBuyin),
			pool.query(sqlCCChipsMonthlySettle),
			pool.query(sqlNNChipsMonthlySettle),
			pool.query(sqlCashDeposit),
			pool.query(sqlCashWithdraw),
			pool.query(sqlAccountDeposit),
			pool.query(sqlAccountCCChips),
			pool.query(sqlAccountNNChips),
			pool.query(sqlMarkerIssueGame),
			pool.query(sqlMarkerIssueAccount),
			pool.query(sqlTotalRealRolling),
			pool.query(sqlTotalRolling),
			pool.query(sqlTotalCashOutRolling),
			pool.query(sqlTotalCashOut),
			pool.query(sqlWinLoss),
			pool.query(sqlServiceCashGuest),
			pool.query(sqlServiceDepositGuest),
			pool.query(sqlServiceCashJunket),
			pool.query(sqlServiceDepositJunket),
			pool.query(sqlServiceSettle),
			pool.query(sqlCommisionRolling),
			pool.query(sqlManualBalancing),
			pool.query(sqlCommisionCashout),
		]);
		...
		const [
			...
			pool.query(sqlCommissionReset),
			pool.query(sqlSharedRolling),
			pool.query(sqlSharedCashoutCC),
			pool.query(sqlSharedCashout),
			pool.query(sqlSharedRollingReset),
			pool.query(sqlSharedCashoutCCReset),
			pool.query(sqlSharedCashoutReset),
		]);
		...
		try {
			...
			const [games] = await pool.query(commissionQuery);
			...
			if (games && games.length > 0) {
				...
				if (gameIds.length > 0) {
					...
					const [allRecords] = await pool.query(bulkRecordQuery, gameIds);
		...
		const [
			...
			pool.query(sqlWinLossLive),
			pool.query(sqlWinLossTelebet),
			pool.query(sqlNNChipsBuyinCashDeposit),
			pool.query(sqlCCChipsBuyinCashDeposit),
			pool.query(sqlNNChipsBuyinCashOnly),
			pool.query(sqlCCChipsBuyinCashOnly),
			pool.query(sqlNNChipsBuyinGuestAccount),
			pool.query(sqlCCChipsBuyinGuestAccount),
			pool.query(sqlRollerNNSubtract),
			pool.query(sqlRollerNNAdd),
			pool.query(sqlRollerCCSubtract),
			pool.query(sqlRollerCCAdd),
			pool.query(sqlReturnRollerCCChips),
			pool.query(sqlAgentCount),
		]);
