...
(function () {
    ...
    const updateMode = () => {
        ...
        if (colorMode !== null && colorMode !== undefined) {
            ...
            changeMode('color-mode', colorMode)
        }
    ...
    Array.from(colorMode, (mode) => {
        mode.addEventListener('click', (e) => {
            Array.from(colorMode, (el) => {
                el.classList.remove('active')
                document.querySelector('html').setAttribute('data-bs-theme', el.getAttribute('data-value'));
            })
            sessionStorage.setItem('color-mode', mode.getAttribute('data-value'))
            mode.classList.add('active')
            document.querySelector('html').setAttribute('data-bs-theme', mode.getAttribute('data-value'));
    ...
    Array.from(elements, (mode) => {
        mode.addEventListener('click', (e) => {
            Array.from(elements, (el) => {
                el.classList.remove('active')
                document.querySelector('html').setAttribute('data-bs-theme-color', el.getAttribute('data-value'))
            })
