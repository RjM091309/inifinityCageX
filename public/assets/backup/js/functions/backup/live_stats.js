...
$(document).ready(function () {
	...
	var dataTable = $('#live_statistic-tbl').DataTable({
	...
	function reloadData() {
		$.ajax({
			url: '/live_game_statistics_data', // Endpoint to fetch data
			method: 'GET',
	...
	$('#live_statistic-tbl').on('change', '.house-share-live-input', function () {
